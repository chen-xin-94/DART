...
# modified from https://github.com/chen-xin-94/diffusers/blob/main/examples/dreambooth/train_dreambooth_lora.py
# Add support for validation_steps
# fix the issue with snr and prior perservation loss when train batch size is bigger than 1
